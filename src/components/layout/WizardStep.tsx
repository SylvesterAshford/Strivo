...
import { View, KeyboardAvoidingView, Platform, ScrollView, Pressable, useSafeAreaInsets } from "@/rn";
    ...
    >
      ...
      >
        ...
        <View style={{ gap: spacing.sm, marginBottom: spacing["3xl"] }}>
          ...
          <View style={{ height: 4, backgroundColor: colors.bg.track, borderRadius: 2, overflow: "hidden" }}>
            <View style={{ width: `${pct}%`, height: "100%", backgroundColor: colors.accent.base, borderRadius: 2 }} />
          </View>
        </View>
        ...
        <View style={{ gap: spacing.md, marginTop: spacing.md }}>
          ...
          {secondaryLabel && onSecondary ? <Button label={secondaryLabel} variant="secondary" onPress={onSecondary} /> : null}
        </View>
      </View>
    </KeyboardAvoidingView>
  );
