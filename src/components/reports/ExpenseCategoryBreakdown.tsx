...
const PALETTE = [colors.chart.terracotta, colors.chart.dustyBlue, colors.chart.sage, colors.chart.plum];
        ...
        {cleaned.map((c, i) => (
          <View key={`${c.category}-${i}`}>
            ...
            <View style={styles.track}>
              <View style={[styles.fill, { width: `${(c.totalMmk / max) * 100}%`, backgroundColor: PALETTE[i % PALETTE.length] }]} />
            </View>
          </View>
        ))}
      </View>
