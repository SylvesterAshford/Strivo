 ...
 * cascades from the workspace (facts, etc.).
 *
 * Also removes the Supabase auth user when a SUPABASE_SERVICE_ROLE_KEY is
 * configured. Skipping that step leaves the auth record orphaned.
 */
export async function DELETE(req: Request) {
  ...
  // FK CASCADE from workspaces removes facts and other workspace-owned rows.
